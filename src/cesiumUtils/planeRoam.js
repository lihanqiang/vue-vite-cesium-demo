...
const CesiumDrone = new URL('/models/CesiumDrone.glb', import.meta.url).href
const FactoryComplex = new URL('/models/Factory Complex.glb', import.meta.url).href
const OfficeBuilding = new URL('/models/Office Building.glb', import.meta.url).href
const radar_dynamic = new URL('/models/radar_dynamic.glb', import.meta.url).href
